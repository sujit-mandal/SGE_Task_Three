      ...
      <div>
        ...
        <div className="bg-[#081831] px-6 relative">
          <div className="footer-1 text-center max-w-[1154px] mx-auto">
            <h2 className="poppins-semibold text-[21px] text-white mb-4">
          ...
          <div className="footer-2 leading-[150%] text-[#CACACA] border-t border-white pt-[35px] max-w-[1154px] mx-auto mt-[35px] flex flex-col lg:flex-row lg:gap-[117px]">
            <div className="w-[231px]">
              ...
              <p className="mulish-regular text-base">
            ...
            <div className="w-[229px]">
              <div>
                ...
                <ul className="mulish-regular lg:text-base text-sm underline">
                  <a
                    href="https://www.shabujglobal.com/scholarship"
                    target="_blank"
                  ...
                  <a
                    href="https://membership.shabujglobal.com"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <li>CSR</li>
              ...
              <div>
                ...
                <ul className="mulish-regular lg:text-base text-sm underline">
                  <a
                    href="https://www.shabujglobal.com/ChannelPartner"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <li>Channel Partner Career</li>
                  </a>
                  <a
                    href="https://membership.shabujglobal.com"
                    target="_blank"
                  ...
                  <a
                    href="https://www.shabujglobal.com/registration#"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <li>HS Language IELTS</li>
                  </a>
                  <a
                    href="https://webmail.names.co.uk/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <li>Webmail</li>
          ...
          <div className="footer-3 leading-[150%] max-w-[1154px] mx-auto flex lg:flex-row flex-col lg:gap-[114px] border-t border-white">
            <div className="lg:border-none border-b border-white pb-[25px]">
              <div className="lg:w-[577px] lg:h-[164px] w-[309px] bg-[rgba(255,255,255,0.7)] rounded-2xl text-center mt-[27px] mb-[31px]">
                <h2 className="poppins-semibold text-[28px] text-[#081831] leading-[39.2px] pt-[14px] pb-[30px]">
            ...
            <div>
              <h2 className="lg:mulish-bold mulish-regular uppercase text-base text-center text-[#CACACA] mb-6 mt-4">
                Our offices
              </h2>
              <div className="lg:flex block gap-[23px]">
                <div className="flex flex-wrap lg:flex-nowrap lg:gap-[23px] gap-4">
                  <div>
                    <h3 className="mulish-bold text-base text-[#5093FB] text-center lg:text-left mb-[18px]">
                      Head Office (London)
                    </h3>
                    <h3 className="mulish-bold text-base text-[#5093FB]">
                      South Asian Regional<br></br> Head Office (Dhaka)
                    </h3>
                    <p className="mulish-regular text-base text-[#CACACA]">
                      Chattogram Office
                    </p>
                    <p className="mulish-regular text-base text-[#CACACA] mb-0">
                      Sylhet Office
                    </p>
                  </div>
                  <div>
                    ...
                    <h3 className="mulish-bold text-base text-[#5093FB] pt-[20px]">
                      Middle East Office
                    </h3>
                    <p className="mulish-regular text-base text-[#CACACA] mb-[31px]">
                      Dubai
                    </p>
                  </div>
                  <div>
          ...
          <div className="footer-4 max-w-[1154px] mx-auto pb-6 flex flex-col lg:flex-row justify-between items-center border-t border-white">
            <div className="flex gap-[26px] mt-[21px] lg:border-none border-b border-white lg:w-1/3 w-full pb-[11px]">
              ...
              <a
                href="https://www.linkedin.com/company/shabuj-global-education/mycompany"
                target="_blank"
                rel="noopener noreferrer"
              >
